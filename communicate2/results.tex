...
This task is difficult because Stochastic Neighbor Compression has already optimized the classifiers to avoid redundancy.
...
\oursp enables much greater speedups for a given level of accuracy degredation.}
\label{fig:ucr}
\end{center}
\end{figure}
