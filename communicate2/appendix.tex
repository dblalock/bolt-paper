...
The \texttt{optimal\_split\_value} algorithms finds the best threshold at which to split a bucket within a given dimension. To do this, it uses the \texttt{cumulative\_sse} function (\ref{algo:cumSSE}) to help evaluate the loss associated with the resulting child buckets.
