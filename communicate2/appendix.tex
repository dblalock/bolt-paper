...
\begin{theorem}[Bias and squared error of Averaging Integer Sum Estimator within a subspace]
...
\end{theorem}
\begin{proof}
This follows immediately from the fact that the overall sum is estimated within each of $C / U$ subspaces of size $U$, and the errors in each subspace are assumed independent.
\end{proof}
