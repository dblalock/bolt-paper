...
Our task is to construct three functions $g: \mathbb{R}^D \rightarrow \mathcal{G}$, $h: \mathbb{R}^D \rightarrow \mathcal{H}$, and $\hat{d}: \mathcal{G} \times \mathcal{H} \rightarrow R$ such that the loss:
\begin{align}
